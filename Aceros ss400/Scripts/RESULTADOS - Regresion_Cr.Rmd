...
load("./Outputs/reg_Cr/Modelo_regresion_Cr.RData")
...
## 3 predicciones se promedian 
## media de media anterior
## Que pasa con MAE y MSE

test.2 <-  predict.sPLS[["predict"]][,,3]
val.2 <- predict.VAL[["predict"]][,,3]
...
```{r}
openxlsx::write.xlsx(L, file = './Outputs/regresion Cr/componentes.xlsx')
```